                    ...
                    <div class="row relative">
                        ...
                        <div class="col-md-9 col-sm-11 col-xs-11 coin" shop="0">
                            <div class="row relative user_panel">
                                ...
                                <div class="col-md-12 panel_page">
                                    <div class="page_title text-center">
                                        Siz hər hansı paket və ya xidmət almamısınız!
                                    </div>
                                    <div class="text-center">
                                        <img src="img/notfound.png" alt="" class="page_img">
                                    </div>
                                    <div class="text-center page_desc margin_bottom_30">
                                        Zəhmət olmasa paketlər bölməsinə daxil olaraq paket aldıqdan sonra bizə sorğu yazın.
                                    </div>
                                    <div class="margin_bottom_30 text-center">
                                        <button class="btn btn-effect">Paketlər</button>
                                    </div>
                                </div>
