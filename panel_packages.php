                                ...
                                <div class="row relative user_panel">
                                    <div class="nav-panel">
                                        <ul class="nav navbar-nav navbar-left">
                                            <li class="active"><a href="panel_queries.php">Sürücü</a></li>
                                            <li><a href="executing_queries.php">Fərdi</a></li>
                                            <li><a href="finished_queries.php">Korporativ</a></li>
                                        </ul>
                                    </div>
                                    <div class="cards_package">
                                        <div class="card_item standart_card">
                                            <div class="head">
                                                <div class="type_col">
                                                ...
                                                <div class="balance_col">
                                                    ...
                                                    <span class="title">Bir illik qiyməti</span>
                                                </div>
                                            </div>
                                            <div class="foot">
                                                <div class="left">
                                                    <span class="label_date">Son istifadə müddəti</span>
                                        ...
                                        <div class="card_item premium_card">
                                            <div class="head">
                                                <div class="type_col">
                                                    <img src="img/diamond.svg" alt="#">
                                                    <span>PREMİUM</span>
